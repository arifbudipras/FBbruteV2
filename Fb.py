#!usr/bin/python
#Facebook Cracker V.2 dapat meretas ke dalam Database Facebook 100% tanpa gangguan oleh Facebook Firewall!
#Gunakan Dengan Bijak :)
#Bukan digunakan untuk kepentingan pribadi !!!
...
GHT = '''
        ...
        +---------------------------------------+
        |#Author: Abip New User                 |
        |#https://github.com/arifbudipras       |
        |#Date: 02/04/2013                      |
